...
const CustomerLogin = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await onLogin({ cnicNumber, password });
    ...
    <div className="login-container">
      ...
      <div className="login-left">
        ...
        <div className="admin-badge">
          <ShieldCheck size={18} /> Customer Portal
        </div>
      ...
      <div className="login-right">
        ...
        <p className="subtitle">
          Only Authorized Customers Can Login From Here
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? <span className="spinner"></span> : "Sign in as Customer"}
          </button>
        </form>
